export default function Dashboard() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16 text-center">
      ...
      <h1 className="text-3xl font-bold text-primary mb-4">Instructor Dashboard</h1>
      <p className="text-text-muted max-w-lg mx-auto mb-8">
        This page will display an overview of your recent submissions, course statistics,
        and quick actions for managing your assignments.
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
        {['Recent Submissions', 'Course Overview', 'Quick Stats'].map((item) => (
