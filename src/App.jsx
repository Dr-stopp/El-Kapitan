...
import SubmissionReportPage from './components/Instructor/SubmissionReportPage';
import SubmissionComparePage from './components/Instructor/SubmissionComparePage';
import './App.css';
...
function App() {
  ...
  return (
    <div className="app-wrapper">
      ...
      {user && (
        <header className="top-nav">
          ...
          <div className="header-left">
            <div className="header-logo brandMark"><BrandMark /></div>
            <div className="header-brand-wrap">
              <span className="header-brand">EL Kapitan</span>
              <span className="header-subbrand">Academic Integrity Portal</span>
            </div>
          </div>
      ...
      {/* Logged in → use route-based rendering */}
      {user && (
        <Routes>
          ...
          {/* Logged in as instructor → show Instructor pages */}
          {user.role === 'instructor' && (
            <>
              <Route
                path="/instructor"
                element={<InstructorDashboard user={user} onLogout={handleLogout} />}
              />
              <Route
                path="/instructor/report/:submissionId"
                element={<SubmissionReportPage />}
              />
              <Route
                path="/instructor/compare/:submissionId"
                element={<SubmissionComparePage />}
              />
