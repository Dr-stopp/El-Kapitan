export default function AnalyticsPanel({
    ...
    const safeMetrics = metrics ?? {
        ...
        flaggedCases: 0,
        reviewCases: 0,
        publishedAssignments: assignments.filter((item) => item.is_visible).length,
    };
    ...
    const cards = [
        {
            ...
            note: 'Across current review dataset',
        },
        {
            label: 'Flagged Cases',
        ...
        },
        {
            ...
            value: safeMetrics.publishedAssignments,
            note: 'Visible to students right now',
        },
    ];
        ...
        <div className="teacherPageShell">
            ...
            {!selectedCourse && (
                <div className="teacherCard teacherEmptyState">
                    Select a course in the Assignments tab first, then return here to view instructor analytics.
                </div>
            )}
